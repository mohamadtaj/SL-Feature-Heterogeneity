...
#---------------------------------------------------------------------------------------------------------------------   
    ...
    elif (dataset == 's_500_num'):
        path = './data/s_500_num'
        df = pd.read_csv(os.path.join(path, 's_500_num.csv')) 
        feature_type_dict = {
            'X1': 'numeric',
            'X2': 'numeric',
            'X3': 'numeric',
...
#--------------------------------------------------------------------------------------------------------------------- 
    ...
    elif (dataset == 's_500_cat'):
        path = './data/s_500_cat'
        df = pd.read_csv(os.path.join(path, 's_500_cat.csv')) 
        feature_type_dict = {
            'X1': 'categorical',
            'X2': 'categorical',
            'X3': 'categorical',
...
#--------------------------------------------------------------------------------------------------------------------- 
    ...
    elif (dataset == 's_500_mix'):
        path = './data/s_500_mix'
        df = pd.read_csv(os.path.join(path, 's_500_mix.csv')) 
        feature_type_dict = {
            'X1': 'numeric',
            'X2': 'numeric',
            'X3': 'numeric',
