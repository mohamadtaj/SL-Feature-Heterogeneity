...
METHOD_ALIASES = {
    "surrogate_splits": "surrogate_split_agreement_pr_01",
    "marginal_prediction": "informed_marginal_cat_simple",
    "informed_probabilistic_routing": "probability_informed_cat_simple_fallback_fixed",
    "feasible_path_voting": "intersection",
    "park_et_al": "treewise_filtering",
    "probabilistic_routing": "probability_weighted",
}
...
parser.add_argument("--jaccard", type=float, help="Target Jaccard similarity in [0, 1] (e.g., 0.3)", default=0.5)

args = vars(parser.parse_args())

args["method"] = METHOD_ALIASES.get(args["method"], args["method"])
args["overlap_percentage"] = 100.0 * args["jaccard"]
